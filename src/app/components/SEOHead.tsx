...
const DEFAULT_DESCRIPTION =
  "개원 준비부터 확장·리모델링까지. KB국민카드·하나카드·신한카드·신협중앙회·하나캐피탈 공식 파트너. 의료기기 렌탈, 중고장비 매입, 긴급자금 D+5일 집행. 누적 지원금액 300억+, 협력병원 450+.";

const KEYWORDS =
  "의료기기 렌탈, 병원 금융, 의료기기 금융, 신규개원 자금, 개원 비용, 개원 자금 대출, 의료기기 구매, 중고 의료기기 매입, 병원 대출, 병원 리모델링 대출, 병원 운영자금, 긴급자금, KB국민카드 병원, 신협 데일리론, 하나캐피탈 의료기기, 캐피탈 렌탈, 모두빌스, B2B 렌탈, 사업자 렌탈, 병원 렌탈, 닥터론, 메디컬론, 의사 대출, 전문직 대출, 개원의 대출, 리스 vs 렌탈, 의료장비 리스, 의료기기 비용처리, 렌탈 절세, MRI 렌탈, CT 렌탈, 초음파 장비 렌탈, 내시경 렌탈, 엑스레이 렌탈, 치과 개원 자금, 치과 장비 렌탈, 성형외과 의료기기, 피부과 레이저 렌탈, 정형외과 장비 렌탈, 안과 의료기기, 이비인후과 장비, 산부인과 초음파, 재활의학과 장비 렌탈, 내과 내시경 렌탈, 외과 의료기기, 비뇨기과 장비, 신경외과 장비, 영상의학과 장비";
...
const LD_FINANCIAL_SERVICE = JSON.stringify({
  ...
  telephone: "010-9892-1927",
  priceRange: "무료 상담",
  description: "병원 의료기기 렌탈·금융 전문 기업. KB국민카드, 하나카드, 신한카드, 신협중앙회, 하나캐피탈 공식 파트너.",
  address: { "@type": "PostalAddress", addressCountry: "KR" },
...
const LD_SERVICE_LIST = JSON.stringify({
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "개인사업자 특별한도 상품", description: "KB·하나·신한 제휴. 개인사업자 전용 최대 2억, 최단 D+5일 자금 집행.", url: `${SITE_URL}/#services` },
...
const LD_FAQ = JSON.stringify({
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "KB국민카드·하나카드·신한카드 제휴를 통해 최단 D+5일(영업일 기준) 자금 집행이 가능합니다. 서류 준비부터 집행까지 전담 컨설턴트가 동행합니다." },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "KB국민카드, 하나카드, 신한카드, 신협중앙회, 하나캐피탈과 공식 파트너십을 맺고 있으며, 각 기관의 조건에 맞는 최적 상품을 비교하여 제안드립니다." },
    },
  ],
});
